...
<div class="cut-navbar col-lg-7 col-md-7 col-sm-7 col-xs-11  col-lg-offset-2">
    ...
    <div class="cut-navbar-menu col-lg-12 col-xs-12">
        <ul>
            ...
            <?php if ($a_pud >= 3) {?><li> <a href="new_account-4.php"><span>寶物兌換</span></a></li><?php }?>
    ...
    <div class="menu col-lg-11 col-xs-11" align="center">
        <div style=" border: 1px solid #b6c9d9">
            ...
            <form id="form1" name="form1" method="get" action="new_account-2.php">
            <table align="center" cellpadding="10" cellspacing="3" class="menu-table" style="margin: 60px auto 30px ">
                <tbody>
                    <tr class="menu-tr">
                      <td colspan="2" align="center"><span style="color: #F00"><?php echo $_GET['err'];?></span></td>
                  </tr>
                    <tr class="menu-tr">
                        <td colspan="2"><span>目前可使用註冊積分餘額</span><span style="color: red;margin-left: 15px"><?php $pc=$row_Recocz['csum']+0;$pc2=number_format($pc, 0, '.' ,',');echo $pc2;?></span></td>
                    </tr>
                    <!--<tr class="menu-tr">
                    ...
                    <tr class="menu-tr">
                      <td colspan="2" class="menu-td"><div style="margin-left: 110px;line-height: 1px;margin-top: 14px">*請輸入數字或英文字母</div></td>
                    </tr>
                    <tr class="menu-tr">
                        <td class="menu-td">介紹人登入帳號</td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" class="ann-t">
                            <div style="margin-left: 120px;line-height: 1px;margin-top: 14px">*請輸入數字或英文字母</div>
                        </td>
                    </tr>
                    <tr class="menu-tr">
                        <td class="menu-td">購買者登入帳號</td>
                        <td>
                            <input name="newuser" type="text" id="newuser" value="<?php if ($_GET['newuser'] != "") {echo $_GET['newuser'];} else {echo " ";}?>" size="12" maxlength="10" placeholder="請輸入電話或暱稱或公司行號">
                        </td>
                    </tr>
                    <tr class="menu-tr">
                        <td class="menu-td">購買商品</td>
                        <td>
                            <select name="pudid"  id="pudid">
                              <?php do {?>
                              <option value="<?php echo $row_Reca['id'];?>" <?php if ($_GET['pudid'] == $row_Reca['id']) {echo "selected='selected'";}?>><?php echo $row_Reca['name'],"系統  $ ",number_format($row_Reca['p'], 0, '.' ,',')," /年繳 ";?></option>
                  ...
                  驗證碼</td>
                    ...
                    <tr align="center">
                        <td colspan="2">
                            <input type="submit" name="button" id="button" class="menu-but"  value="下一步">
