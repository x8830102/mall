...
<div class="cut-navbar col-lg-7 col-md-7 col-sm-7 col-xs-11  col-lg-offset-2">
    ...
    <div class="cut-navbar-menu col-lg-12 col-xs-12">
        <ul>
            <li class="active"> <a href="fan_management_1.php"><span>粉絲數管理</span></a> </li>
            <li> <a href="fan_management_2.php"><span>推廣數管理</span></a> </li>
            <li> <a href="fan_management_3.php"><span>寶物數管理</span></a> </li>
        </ul>
    </div>
    <div class="menu col-lg-11 col-xs-11" align="center">
        <div style=" border: 1px solid #b6c9d9">
            <div class="menu-text col-lg-12 col-md-12 col-xs-12">免費註冊粉絲數管理</div>
        ...
        <form id="form2" name="form2" method="post" action="fan_management_1.php">
        <?php //
if ($_GET['sd1'] != "") {
	$sd1=$_GET['sd1'];$sd2=$_GET['sd2'];
	$key="SELECT * FROM memberdata WHERE fname = '$username' && date >= '$sd1' && date <= '$sd2' ORDER BY m_id DESC";
	} else {$key="SELECT * FROM memberdata WHERE fname = '$username' ORDER BY m_id DESC";}
//
...
<div style="  margin-top: 10px" class="table-responsive ">
  <div class="inquire">
                ...
                <ul>
                    <li><span>總粉絲數</span><span><?php $totalRows_Recoc+0;?></span> </li>
                    <li></li>
                </ul>
    </div>
    <table class="integral-tb table" width="100%" style="min-width: 100%">
        <tbody>
            <tr class="integral-frist-tr">
                ...
                <td style="width: 15%;border-top: 0px">名稱</td>
                <td style="width: 15%;border-top: 0px">間接粉絲</td>
            ...
            <?php $pj=$_GET['pj']+0;if ($totalRows_Recoc != 0) {do {$pj++;?><tr class="integral-tr">
                ...
                <td><span><?php $us2=$row_Recoc['m_username'];mysql_select_db($database_sc, $sc);
...
$totalRows_Recfb2 = mysql_num_rows($Recfb2);echo $totalRows_Recfb2;?></span></td>
                <td><span><?php $fb3_total=0;
