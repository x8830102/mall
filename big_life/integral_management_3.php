	...
	if ($totalRows_Recmem2 != 0) {
		...
		if ($row_Recoc2['csum'] >= $pay) {
			...
			if ($totalRows_Recmem3 != 0) {
				...
				$my_note="購物積分轉出<br/>帳號:".$yuser."/".$row_Recmem3['m_nick'];
			    mysql_select_db($database_sc, $sc);
...
<div class="cut-navbar col-lg-7 col-md-7 col-sm-7 col-xs-11  col-lg-offset-2">
    ...
    <div class="cut-navbar-menu col-lg-12 col-xs-12">
        <ul>
            ...
            <li class="active"> <a href="integral_management_3.php"><span>購物積分</span></a> </li>
    ...
    <div class="menu col-lg-11 col-xs-11" align="center">
        <div style=" border: 1px solid #b6c9d9">
            <div class="menu-text col-lg-12 col-md-12 col-xs-12">購物積分管理</div>
            ...
            <table align="center" cellpadding="10" cellspacing="3" class="menu-table" style="margin: 50px auto 30px ">
                <tbody>
                    ...
                    <tr class="menu-tr">
                        <td colspan="2"><span>購物積分結餘</span><span style="color: red;margin-left: 15px"><?php $pc=$row_Recocz['csum']+0;$pc2=number_format($pc, 0, '.' ,',');echo $pc2;?></span>&nbsp;&nbsp;&nbsp;<?php if ($pc == 0) {echo "轉出功能暫停";}?></td>
                    </tr><?php if ($pc != 0) {?>
                    <tr class="menu-tr">
