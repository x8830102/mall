...
if ((isset($HTTP_POST_VARS["MM_update"])) && ($HTTP_POST_VARS["MM_update"] == "form1")) {
    ...
    $myus=$HTTP_POST_VARS['number'];$passtoo=$HTTP_POST_VARS['passtoo'];$note2=$_POST['note2'];$st=$_POST['st'];
...
<div class="cut-navbar col-lg-7 col-md-7 col-sm-7 col-xs-11  col-lg-offset-2">
    ...
    <div class="menu col-lg-11 col-xs-11" align="center">
          ...
          <div class="menu-text col-lg-12 col-md-12 col-xs-12">串串積分管理</div>
            ...
            <table align="center" cellpadding="10" cellspacing="3" class="menu-table" style="margin: 50px auto 30px ">
                <tbody>
                    ...
                    <tr class="menu-tr">
                        <td colspan="2"><span>串串積分結餘</span><span style="color: red;margin-left: 15px"><?php $pc=$row_Recocz['csum']+0;$pc2=number_format($pc, 0, '.' ,',');echo $pc2;?></span></td>
                    </tr><?php if ($pc != 0) {?>
                    <tr class="menu-tr">
                    ...
                    <tr >
                      <td align="right"><input name="st" type="radio" id="radio" value="1" checked="checked" /></td>
                      <td>轉到自己註冊積分</td>
                    </tr>
                    <tr >
                      <td align="right"><input type="radio" name="st" id="radio2" value="2" /></td>
                      <td>轉至會員帳號
                      <input name="yuser" type="text" id="yuser" placeholder=""></td>
                    </tr>
                    <tr class="menu-tr">
        ...
        <div style="  margin-top: 10px" class="table-responsive ">
            <div class="inquire"><form id="form2" name="form2" method="get" action="integral_management_2.php">
                <ul>
                    <li>查詢日期</li>
                    <li>
