	...
	if ($totalRows_Recmem2 != 0) {
		...
		if ($row_Recoc2['csum'] >= $pay) {
			...
			if ($totalRows_Recmem3 != 0) {
				...
				$my_note="註冊積分轉出給帳號:".$yuser."/".$row_Recmem3['m_nick'];
			    mysql_select_db($database_sc, $sc);
        ...
        <div style=" border: 1px solid #b6c9d9">
            ...
            <table align="center" cellpadding="10" cellspacing="3" class="menu-table" style="margin: 50px auto 30px ">
                <tbody>
                    ...
                    <tr class="menu-tr">
                        <td colspan="2"><span>註冊積分餘額</span><span style="color: red;margin-left: 15px"><?php $pc=$row_Recocz['csum']+0;$pc2=number_format($pc, 0, '.' ,',');echo $pc2;?></span></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="ann-t">
                            <div style="margin-left: -10px ; line-height: 1px;">（註冊積分只限於訂購系統使用，不可作為其他用途）</div>
                        </td>
                    </tr> <?php if ($pc != 0) {?>
                    <tr class="menu-tr">
                    ...
                    <tr class="menu-tr">
                        ...
                        <td>
                            <input name="passtoo" type="password" id="passtoo" size="12" placeholder="密碼預設123456">
