...
<div class="cut-navbar col-lg-7 col-md-7 col-sm-7 col-xs-11  col-lg-offset-2">
    ...
    <div class="menu col-lg-11 col-xs-11" align="center">
        <div style=" border: 1px solid #E3D6C7">
            <div class="menu-text col-lg-12 col-md-12 col-xs-12">送出成功</div>
            <table align="center" cellpadding="10" cellspacing="3" class="menu-table" style="margin: 50px auto 30px ">
                <tbody>
                    <tr class="menu-tr">
                        <td colspan="2"><span>歡迎您加入LIFE LINK串門子合作開發團隊，一起共創事業。</span></td>
                    </tr>
                    <tr class="menu-tr">
                        <td colspan="2"><span>★請耐心等候審核。</span></td>
                    </tr>
                    <tr class="menu-tr">
                        <td colspan="2"><span>★審核期間請報名串門子網路平台使用教學課程，以取得必要條件~"教師認證"。</span></td>
                    </tr>
                    <tr class="menu-tr">
                        <td colspan="2"><span>★請主動聯絡公司或上網查詢預約平台使用課程教學時間。</span></td>
                    </tr>
                    <tr class="menu-tr">
                        <td colspan="2"><span>&nbsp;</td>
                    </tr>
                    <tr class="menu-tr">
                        <td colspan="2"><span>logo  串們子網路平台教學團隊</td>
                    </tr>
                </tbody>
            </table>
        </div>
