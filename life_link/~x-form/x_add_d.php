...
$fus=$_SESSION['gfus'];$newnr=$_SESSION['newnr'];$pudid=$_SESSION['pudid'];$vfdcard=$_SESSION['fdcard'];$newfb=$_SESSION['newfb'];$torg=111;

?>

<div id="divLoading" style="color:red; position:absolute; top:168px; left:730px;z-order=0">
...
$fdsql="fd2";$pcpin=150000;$pcpout=300000;
...
$wi=2;$fd_t_card=$newfb;//echo "@@##",$newfb;exit;
...
$p_total=0;$tt_us=$fd_t_card;$keyok=0;
...
mysql_query($insertCommand13,$sc);
    ...
    mysql_query($insertCommand15,$sc);*/
		...
		$_SESSION['fdcard']=$fdcard;$torg=0;//$torg=111;
...
if ($torg == 0) {?><script type="text/javascript">document.location.href="x_add_d.php";</script>

<?php } else {$_SESSION['fdcard']=$fdcard;?><script type="text/javascript">document.location.href="x_add_d2.php";</script><?php }?>
