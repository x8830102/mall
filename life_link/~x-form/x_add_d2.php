...
?>
<div id="divLoading" style="color:red; position:absolute; top:166px; left:703px;"> <img src="/life_link/ajax-loader.gif" border="0" style="vertical-align:middle;padding:6px"/> </div>
...
if ($row_Reccd['a_pud'] < 6) {$fdsql="fd";$pcpin=15000;$pcpout=30000;}if ($row_Reccd['a_pud'] >= 6) {$fdsql="fd2";$pcpin=150000;$pcpout=300000;}
//7p-yes
$p_total=0;
mysql_select_db($database_sc, $sc);
