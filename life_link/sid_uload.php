...
<div class="order">
  ...
  <form action="sid_add.php" method="post" enctype="multipart/form-data" name="form1" id="form1" >
  <div class="col-lg-4 col-md-4" align="center">
    <ul>
      <li><h3 align="center">身分證圖上傳系統 </h3></li>
      <li>選擇上傳檔案</li>
      <li><input name="MAX_FILE_SIZE" type="hidden" id="MAX_FILE_SIZE" value="10000000000" />
            <input name="myfile" type="file" class="sid" id="myfile" /> <span style="color: #0028E9"></li>
    </ul>
  </div>
  <div class="col-lg-4 col-md-4" align="center">
     <ul>
      ...
      <li style="margin-top:-8px "><input name="Submit4" type="button" class="button " onclick="window.location='member_profile02.php'" value="取消 " />
          </span></li>
    </ul>
  </div>
  </form>
