        ...
        <div class="container-fluid col-xs-12">
            <div class=" navbar-default navbar-fixed-top" align="">
                <div class="navbar-header">
                    ...
                    <a href="index.php">
                        <img src="img/life-link_logo.png" width="180px" alt="串門子雲端"></a>
                    </div>
                    <button id="hidden" type="botton" class="navbar-toggle " data-toggle="offcanvas" data-target=".navmenu" data-canvas="body" onclick="b()" style="margin-left:15px;top: -90px ">
                    ...
                    <div class="member-bar" style="margin-top: -61px">
                        ...
                        <ul class="drop-down-menu">
                            <li class="login-t hidden-xs"> <span>登入時間：<?php echo date("Y-m-d H:i:s");?></span>
                                
                    </li>
                            <li class="col-lg-6 col-md-5 col-sm-3 col-xs-1"></li>
                            ...
                            <li class="member-info" style="margin-left: -2px;"><?php echo $nick;?> 您好
                                
                            </li>
                            <li class="member-info" > <a href="logout.php" target="_top">會員登出</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="navmenu navmenu-default navmenu-fixed-left offcanvas">
                <div class="side-bar hidden-lg hidden-md hidden-sm">
                    <ul>
                        <li><div style="color: #5E4D87;font-size: 15px">登入時間：<br><?php echo date("Y-m-d H:i:s");?>
                            <button id="visible" type="botton" class="navbar-toggle " data-toggle="offcanvas" data-target=".navmenu" onclick="c()" data-canvas="body" style="position: absolute;top: 18px;right: 0px;">
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                            </button>
				...
				<tr>
                    ...
                    <td  style="border-top: 0px;color: #C98C9C;font-size: 13px" align="right"><?php echo number_format($result_cf['psum'], 0, '.' ,',');?></td>
                        ...
                        <li>
                            ...
                            <?php if ($a_pud >= 5) {?><button type="button" class="sidebtn02"><a href="new_account-4.php" style="color:#fff">兌換福袋</a></button><? } else {?><button type="button" class="sidebtn02" style="background: #eee;color: #fff;cursor:no-drop">兌換福袋</button><? }?>
                        </li>
                        <li>
                            <table class="table table-hover">
                                <tbody>
...
echo $p_total;?> / 6</option><?php } while ($row_Recfd3 = mysql_fetch_assoc($Recfd3));?>
                    ...
                    <table class="table" style="">
                        <tbody>
                         ...
                         <!--<li class="b-bar "><a href="#">操作手冊<span class="icon-a"></span></a></li>-->
