...
$key="SELECT * FROM pay_f ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_f WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_f WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_f.php'" data-value="pay_f" value="經銷商" /></td>
