...
$key="SELECT * FROM pay_i ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_i WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_i WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_i.php'" data-value="pay_i" value="分享積分" /></td>
