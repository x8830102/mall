...
$key="SELECT * FROM pay_l ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_l WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_l WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_l.php'" data-value="pay_l" value="核心運作" /></td>
