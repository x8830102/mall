...
$key="SELECT * FROM pay_g  ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_g WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_g WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_g.php'" data-value="pay_g" value="產品成本" /></td>
