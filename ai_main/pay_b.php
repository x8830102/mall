...
$key="SELECT * FROM pay_b  ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_b WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_b WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_b.php'" data-value="pay_b" value="福袋積分" /></td>
