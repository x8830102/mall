...
$key="SELECT * FROM pay_k ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_k WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_k WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_k.php'" data-value="pay_k" value="內勤福利" /></td>
