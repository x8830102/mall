...
$key="SELECT * FROM pay_db ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_db WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_db WHERE pout <> $b");
...
$(document).ready(function() {
  base = $(".style181").attr("data-value");//alert(base);
    $.ajax({
        type: "POST",
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_db.php'" data-value="pay_db" value="金流刷卡" /></td>
            ...
            <td ><input name="Submit3" type="button" class="style171" onclick="window.location='pay_c.php'" value="靜態分紅" /></td>
