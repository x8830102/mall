...
$query_Recb = sprintf("SELECT * FROM memberdata WHERE m_id = $usid && a_pud <> $aaa && prd2=2");// DESC
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="10" cellpadding="0">
      <tr>
        <td bgcolor="<?php switch ($prd2) {case'1':echo "#FFF";break;case'2':echo "#FFFF66";break;case'3':echo "#FF9900";break;}?>"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
...
$query_Recg1 = sprintf("SELECT * FROM memberdata WHERE m_guser2 = '$bmem_number' && gtow2='$gtow' && prd2 = $prd2 && a_pud != $aaa");
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile521"><a href="graph2.php?boy=<?php echo $g1id;?>&amp;d=<?php echo $di+1;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile131"/></a><br />
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile521"><a href="graph2.php?boy=<?php echo $g2id;?>&amp;d=<?php echo $di+1;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1321"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
...
mysql_select_db($database_kg, $kg);$gtow="L";
$query_Recg1 = sprintf("SELECT * FROM memberdata WHERE m_guser2 = '$g1' && gtow2='$gtow' && prd2=$prd2 && a_pud != 0");
$Recg1 = mysql_query($query_Recg1, $kg) or die(mysql_error());
$row_Recg1 = mysql_fetch_assoc($Recg1);
$totalRows_Recg1 = mysql_num_rows($Recg1);
...
?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile581"><a href="graph2.php?boy=<?php echo $g3id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1361"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
...
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="graph2.php?boy=<?php echo $g3id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile1182" /></a>
                  <?php }?>
                  <?php } //else {if ($now_tm >= 0  && $row_Recb['prd'] == 1) {?>
                  <!--<table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
...
?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile591"><a href="graph2.php?boy=<?php echo $g4id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1371"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
...
$row_Recg2 = mysql_fetch_assoc($Recg2);
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="graph2.php?boy=<?php echo $g4id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile11821" /></a>
                  <?php }?>
                  <?php } //else {if ($now_tm >= 0  && $row_Recb['prd'] == 1) {?>
                  <!--<table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
...
mysql_select_db($database_kg, $kg);$gtow="L";
$query_Recg1 = sprintf("SELECT * FROM memberdata WHERE m_guser2 = '$g2' && gtow2='$gtow' && prd2=$prd2 && a_pud != 0");
$Recg1 = mysql_query($query_Recg1, $kg) or die(mysql_error());
$row_Recg1 = mysql_fetch_assoc($Recg1);
$totalRows_Recg1 = mysql_num_rows($Recg1);
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile5101"><a href="graph2.php?boy=<?php echo $g5id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1381"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
...
$row_Recg2 = mysql_fetch_assoc($Recg2);
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="graph2.php?boy=<?php echo $g5id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile11822" /></a>
                  <?php }?>
                  <?php } //else {if ($now_tm >= 0 && $row_Recb['prd'] == 1) {?>
                  <!--<table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile5181"><a href="graph2.php?boy=<?php echo $g6id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic;?>.png" width="45" border="0"  class="profile1391"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
...
$row_Recg2 = mysql_fetch_assoc($Recg2);
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="graph2.php?boy=<?php echo $g6id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile11823" /></a>
                  <?php }?>
                  <?php } //else {if ($now_tm >= 0 && $row_Recb['prd'] == 1) {?>
                  <!--<table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
