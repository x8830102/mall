...
$key="SELECT * FROM pay_h  ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_h WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_h WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_h.php'" data-value="pay_h" value="促銷獎勵" /></td>
