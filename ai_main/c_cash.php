...
$query_RecProduct = "SELECT * FROM c_cash WHERE cout = 0 ORDER BY id DESC";// 
...
$r_total=0;
mysql_select_db($database_sc, $sc);
$query_Recoc = sprintf("SELECT * FROM c_cash WHERE cout = 0 ORDER BY id DESC");
      ...
      <tr>
        <td colspan="2"><table width="100" border="0" cellspacing="10" cellpadding="0">
          <tr>
            ...
            <td ><input name="Submit" type="button" class="style181" onclick="window.location='c_cash.php'" value="串串積分" /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
