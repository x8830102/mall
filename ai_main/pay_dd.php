...
$key="SELECT * FROM pay_dd ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_dd WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_dd WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_dd.php'" data-value="pay_dd" value="人事管銷" /></td>
