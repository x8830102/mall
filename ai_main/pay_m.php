...
$key="SELECT * FROM pay_m ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_m WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_m WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_m.php'" data-value="pay_m" value="公司運作" /></td>
