...
$query_Recb = sprintf("SELECT * FROM memberdata WHERE m_id = $usid && a_pud <> $aaa");// DESC
...
$svpic=$ms;
$prd=$row_Recb['prd'];//echo $prd;exit;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="10" cellpadding="0">
      ...
      <tr>
        <td valign="top" background="images/2-2.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="5%"><!--<a id="a1" href="javascript:;" onclick="change()"><img id="a2" src="images/5-1.png" width="58" height="35" border="0" /></a>--></td>
            <td width="84%"><table width="200" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>登录 IP : <?php echo $ip;?></td>
              </tr>
            </table></td>
      ...
      <tr>
        <td bgcolor="<?php //switch ($prd) {case'1':echo "#FFF";break;case'2':echo "#FFFF66";break;case'3':echo "#FF9900";break;}?>"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
              <tr>
                <td width="200" align="center" bgcolor="#FFFFFF">網路 圖 表 &gt;&gt;&gt;</td>
                <?php if ($row_Recmem['a_pud'] != 0) {?><td width="200" align="center" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0" bordercolor="#55AAFF">
                  <tr>
                    <td width="200" height="43" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="42" align="center"><a href="graph.php">1000 Plan</a></td>
                      </tr>
                    </table></td>
                    </tr>
                  </table></td><?php }?>
                ...
                <td align="right"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
                  <tr>
                    <td width="200" align="center">定位 圖 表 &gt;&gt;&gt;</td>
                    <?php if ($row_Recmem['a_pud'] != 0) {?>
                    <td width="200" align="center" ><table width="100%" border="0" cellspacing="0" cellpadding="0" bordercolor="#55AAFF">
                      <tr>
                        <td width="200" height="43" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0">
                          <tr>
                    ...
                    <?php }?>
                    <?php //if ($row_Recmem['b_pud'] != 0) {?>
                    <!--<td width="200" align="center" bgcolor="#55AAFF"><a href="graph2.php">5000 Plan</a></td><?php //}?>
                <?php //if ($row_Recmem['c_pud'] != 0) {?>
                <td width="200" align="center" bgcolor="#55AAFF"><a href="graph3.php">10000 Plan</a></td>-->
                    <?php //}?>
              ...
              </table><?php //if ($row_Recmem['a_pud'] == 0) {exit;}?></td>
            </tr>
          <tr>
            <td height="35" align="center" valign="middle" bgcolor="#FFFFFF" class="v1"><table width="300" border="0" cellspacing="10" cellpadding="0">
              <tr>
                ...
                <td width="56" align="center"><?php if ($di != 1) {?>
                  <a href="kgraph.php"><img src="../cht/mempic/T.png" width="30" /></a>
                  <?php }?></td>
...
$query_Recg1 = sprintf("SELECT * FROM memberdata WHERE gus = '$bmem_number' && ggtow='$gtow'  && a_pud != $aaa");
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile521"><a href="kgraph.php?boy=<?php echo $g1id;?>&amp;d=<?php echo $di+1;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile131"/></a><br />
                  ...
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" class="profile5110"><a href="account.php?gi=<?php echo $b_id;?>&amp;w=<?php echo $gtow;?>&pudid=1"><img src="../cht/mempic/Q.png" width="128" height="128" border="0" /></a></td>
                      </tr>
                    </table>
                  <?php }}?></td>
                <td width="360" align="center" valign="top"><?php //
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile521"><a href="kgraph.php?boy=<?php echo $g2id;?>&amp;d=<?php echo $di+1;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1321"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
                  ...
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" class="profile5111"><a href="account.php?gi=<?php echo $b_id;?>&amp;w=<?php echo $gtow;?>&pudid=1"><img src="../cht/mempic/Q.png" width="128" height="128" border="0" /></a></td>
                      </tr>
                    </table>
                  <?php }}?></td>
                </tr>
...
mysql_select_db($database_kg, $kg);$gtow="L";
$query_Recg1 = sprintf("SELECT * FROM memberdata WHERE gus = '$g1' && ggtow='$gtow' && a_pud != 0");
$Recg1 = mysql_query($query_Recg1, $kg) or die(mysql_error());
$row_Recg1 = mysql_fetch_assoc($Recg1);
$totalRows_Recg1 = mysql_num_rows($Recg1);
...
?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile581"><a href="kgraph.php?boy=<?php echo $g3id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1361"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
...
$query_Recg2 = sprintf("SELECT * FROM memberdata WHERE gus = '$g3'");
...
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="kgraph.php?boy=<?php echo $g3id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile1182" /></a>
                  <?php }?>
                  <?php } else {if ($now_tm >= 0  && $row_Recb['prd'] == 1) {?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" class="profile5151"><a href="account.php?gi=<?php echo $g1id;?>&amp;w=<?php echo $gtow;?>&pudid=1"><img src="../cht/mempic/Q.png" width="128" height="128" border="0" /></a></td>
                      </tr>
                    </table>
                  <?php }}}?></td>
                <td width="360" align="center" valign="top"><?php if ($g1 !="") {
...
?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile591"><a href="kgraph.php?boy=<?php echo $g4id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1371"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
                  ...
                  <?php mysql_select_db($database_kg, $kg);
$query_Recg2 = sprintf("SELECT * FROM memberdata WHERE gus = '$g4'");
$Recg2 = mysql_query($query_Recg2, $kg) or die(mysql_error());
$row_Recg2 = mysql_fetch_assoc($Recg2);
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="kgraph.php?boy=<?php echo $g4id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile11821" /></a>
                  <?php }?>
                  <?php } else {if ($now_tm >= 0  && $row_Recb['prd'] == 1) {?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" class="profile5161"><a href="account.php?gi=<?php echo $g1id;?>&amp;w=<?php echo $gtow;?>&pudid=1"><img src="../cht/mempic/Q.png" width="128" height="128" border="0" /></a></td>
                      </tr>
                </table>
                  <?php }}}?></td>
                <td width="360" align="center" valign="top"><?php if ($g2 !="") {
mysql_select_db($database_kg, $kg);$gtow="L";
$query_Recg1 = sprintf("SELECT * FROM memberdata WHERE gus = '$g2' && ggtow='$gtow' && a_pud != 0");
$Recg1 = mysql_query($query_Recg1, $kg) or die(mysql_error());
$row_Recg1 = mysql_fetch_assoc($Recg1);
$totalRows_Recg1 = mysql_num_rows($Recg1);
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile5101"><a href="kgraph.php?boy=<?php echo $g5id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic1;?>.png" width="45" border="0"  class="profile1381"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
                  ...
                  <?php mysql_select_db($database_kg, $kg);
$query_Recg2 = sprintf("SELECT * FROM memberdata WHERE gus = '$g5'");
$Recg2 = mysql_query($query_Recg2, $kg) or die(mysql_error());
$row_Recg2 = mysql_fetch_assoc($Recg2);
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="kgraph.php?boy=<?php echo $g5id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile11822" /></a>
                  <?php }?>
                  <?php } else {if ($now_tm >= 0 && $row_Recb['prd'] == 1) {?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" class="profile5171"><a href="account.php?gi=<?php echo $g2id;?>&amp;w=<?php echo $gtow;?>&pudid=1"><img src="../cht/mempic/Q.png" width="128" height="128" border="0" /></a></td>
                      </tr>
                    </table>
                  <?php }}}?></td>
                <td width="360" align="center" valign="top"><?php if ($g2 !="") {
...
$svpic1=$ms;?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" bgcolor="<?php if ($mem_number == $row_Recg1['m_fuser']) {echo "#99CCFF";}?>" class="profile5181"><a href="kgraph.php?boy=<?php echo $g6id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/<?php echo $svpic;?>.png" width="45" border="0"  class="profile1391"/></a><br />
                        ID：<?php echo $row_Recg1['card'];?><br />
                        [ <?php echo $row_Recg1['m_nick'];?> ]<br />
                        直推：<?php echo $totalRows_Recfm1;?></td>
                      </tr>
                  ...
                  <?php mysql_select_db($database_kg, $kg);
$query_Recg2 = sprintf("SELECT * FROM memberdata WHERE gus = '$g6'");
$Recg2 = mysql_query($query_Recg2, $kg) or die(mysql_error());
$row_Recg2 = mysql_fetch_assoc($Recg2);
$totalRows_Recg2 = mysql_num_rows($Recg2);if ($totalRows_Recg2 != 0) {?>
                  <a href="kgraph.php?boy=<?php echo $g6id;?>&amp;d=<?php echo $di+2;?>"><img src="../cht/mempic/G.png" height="45" border="0" class="profile11823" /></a>
                  <?php }?>
                  <?php } else {if ($now_tm >= 0 && $row_Recb['prd'] == 1) {?>
                  <table width="160" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="160" align="center" valign="middle" class="profile5181"><a href="account.php?gi=<?php echo $g2id;?>&amp;w=<?php echo $gtow;?>&pudid=1"><img src="../cht/mempic/Q.png" width="128" height="128" border="0" /></a></td>
                      </tr>
                    </table>
                  <?php }}}?></td>
                </tr>
