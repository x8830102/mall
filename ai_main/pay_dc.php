...
$key="SELECT * FROM pay_dc ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_dc WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_dc WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_dc.php'" data-value="pay_dc" value="系統建置" /></td>
