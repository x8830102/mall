...
$key="SELECT * FROM pay_j ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_j WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_j WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_j.php'" data-value="pay_j" value="車屋/旅遊" /></td>
