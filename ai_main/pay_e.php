...
$key="SELECT * FROM pay_e ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_e WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_e WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_e.php'" data-value="pay_e" value="愛心基金" /></td>
