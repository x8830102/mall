...
$query_RecProduct = "SELECT * FROM r_cash WHERE cout = 0 ORDER BY id DESC";// 
...
$r_total=0;
mysql_select_db($database_sc, $sc);
$query_Recoc = sprintf("SELECT * FROM r_cash WHERE cout = 0 ORDER BY id DESC");
...
您好!</span> <span class="style8">&nbsp;&nbsp;&nbsp;登入帳號：<?php echo $row_Reclu['username'];?></span>&nbsp;&nbsp;</td>
      ...
      <tr>
        <td colspan="2"><table width="100" border="0" cellspacing="10" cellpadding="0">
          <tr>
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='r_cash.php'" value="紅利積分" /></td>
            <td ><input name="Submit" type="button" class="style171" onclick="window.location='g_cash.php'" value="消費積分" /></td>
