...
$key="SELECT * FROM pay_da ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_da WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_da WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_da.php'" data-value="pay_da" value="各項稅務" /></td>
