...
$mc=$_GET['mc'];
mysql_select_db($database_sc, $sc);
$query_Recym = sprintf("SELECT * FROM memberdata WHERE card = '$mc'");
...
mysql_select_db($database_sc, $sc);
$query_RecProduct = "SELECT * FROM o_cash WHERE number = '$yu' ORDER BY id DESC";// 
...
您好!</span> <span class="style8">&nbsp;&nbsp;&nbsp;登入帳號：<?php echo $row_Reclu['username'];?></span>&nbsp;&nbsp;【<a href="amss_pas.php">修改密碼</a>】</td>
      ...
      <tr>
        <td height="550" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="15" cellpadding="0">
          ...
          <tr>
            <td height="35" align="center" valign="middle" bgcolor="#FFFFFF" class="v1">卡號 「 <?php echo $mc;?> 」會員 O 幣</td>
          </tr>
          <tr>
            <td valign="top"><table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#55AAFF">
              <tr>
                <td height="35" colspan="5" align="center" bgcolor="#55AAFF">&nbsp;</td>
              </tr>
              <tr>
                <td width="170" height="35" align="center" bgcolor="#FFFFFF">日期</td>
                <td width="120" align="center" bgcolor="#FFFFFF">收</td>
                <td width="120" align="center" bgcolor="#FFFFFF">支</td>
                <td width="120" align="center" bgcolor="#FFFFFF">餘</td>
              ...
              <tr>
                ...
                <td bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td align="right">- <?php echo $row_RecProduct['cout']+0;?></td>
                  </tr>
                </table></td>
                <td align="center" bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><?php echo $row_RecProduct['csum'];?></td>
              ...
              <tr>
                ...
                <td width="31%" align="center" class="style12"><table width="40" border="0" cellspacing="3" cellpadding="0">
                  <tr>
                    ...
                    <td width="40" align="center" style="color: #FC0"><a href="oc_mem.php?pageNum_RecProduct=<?php echo $pb;?>&amp;ap=<?php echo $ceo;?>&mc=<?php echo $mc;?>"><?php echo $pai,".";?></a></td>
                    <?php $pag--;$pai++;$pb++;}?>
                  </tr>
                </table></td>
