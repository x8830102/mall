...
mysql_select_db($database_sc, $sc);
$query_RecProduct = "SELECT * FROM save_cash WHERE at=1";// ORDER datetime DESC
...
您好!</span> <span class="style8">&nbsp;&nbsp;&nbsp;登入帳號：<?php echo $row_Reclu['username'];?></span>&nbsp;&nbsp;</td>
      ...
      <tr>
        <td height="550" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="15" cellpadding="0">
          ...
          <tr>
            <td height="35" align="center" valign="middle" bgcolor="#FFFFFF" class="v1">會員匯入款儲值管理</td>
          </tr>
          <tr>
            <td valign="top"><table width="1000" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#55AAFF">
              <tr>
                <td height="35" colspan="6" align="center" bgcolor="#55AAFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><form id="form1" name="form1" method="get" action="oc_mem.php">
                      查詢會員卡號 
                    ...
                    <td align="right"><table width="200" border="0" align="right" cellpadding="0" cellspacing="10">
                      <tr>
                        <td width="180" height="25" align="center" bgcolor="#FFFFFF"><a href="oc_save.php">儲值對方</a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
              ...
              <tr>
                <td width="161" height="35" align="center" bgcolor="#FFFFFF">日期</td>
                <td width="116" align="center" bgcolor="#FFFFFF">會員</td>
                <td width="118" align="center" bgcolor="#FFFFFF">申購點數</td>
                <td width="117" align="center" bgcolor="#FFFFFF">匯款金額</td>
                <td width="373" align="center" bgcolor="#FFFFFF">摘要</td>
                <td width="101" align="center" bgcolor="#FFFFFF">&nbsp;</td>
              </tr>
              <?php $coi=0;if ($totalRows_RecProduct != 0) {do {?>
              <tr>
                <td bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><?php echo $row_RecProduct['datetime'];?></td>
                <td bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td align="center"><?php $n=$row_RecProduct['number'];mysql_select_db($database_sc, $sc);
...
$totalRows_Recm = mysql_num_rows($Recm);echo $row_Recm['m_nick'];?><br/><?php echo $row_Recm['m_callphone'];?></td>
                  </tr>
                </table></td>
                <td bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td align="center"><?php echo $row_RecProduct['oc']+0;?></td>
                  </tr>
                </table></td>
                <td align="center" bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><?php echo $row_RecProduct['pay']+0;?></td>
                <td bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>">* <?php echo $row_RecProduct['type']," - ",$row_RecProduct['note'];?></td>
                <td bgcolor="<?php if ($coi == 0) {echo "#E8EFF7";} else {echo "#55AAFF";}?>"><form id="form2" name="form2" method="post" action="oc_insa.php">
                  <input name="sid" type="hidden" id="sid" value="<?php echo $row_RecProduct['id'];?>" />
                  <input type="submit" name="button2" id="button2" value="播出儲值" />
                </form></td>
              </tr>
