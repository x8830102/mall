...
$key="SELECT * FROM pay_d ORDER BY id DESC";
...
$query_Reci = sprintf("SELECT * FROM pay_d WHERE pin <> $b");
...
//
mysql_select_db($database_sc, $sc);
$query_Reco = sprintf("SELECT * FROM pay_d WHERE pout <> $b");
      ...
      <tr>
        <td width="712"><table>
          <tr>
            ...
            <td ><input name="Submit3" type="button" class="style181" onclick="window.location='pay_d.php'" data-value="pay_d" value="組織運作" /></td>
