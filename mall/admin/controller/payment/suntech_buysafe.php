...
class ControllerPaymentSuntechBuysafe extends Controller {
	...
	public function index() {
        ...
        $data['installments_notice'] = $this->language->get('installments_notice');
...
//		$data['confirm'] = HTTP_CATALOG . 'index.php?route=payment/suntech_bussafe/confirm';
        ...
        if (isset($this->request->post['suntech_buysafe_test_mode'])) {
            $data['suntech_buysafe_test_mode'] = $this->request->post['suntech_buysafe_test_mode'];
        } else {
            $data['suntech_buysafe_test_mode'] = $this->config->get('suntech_buysafe_test_mode');
        }
        ...
        $data['installments'] = array(
            '3' => $this->language->get('installments_3'),
            '6' => $this->language->get('installments_6'),
            '12' => $this->language->get('installments_12'),
            '18' => $this->language->get('installments_18'),
            '24' => $this->language->get('installments_24')
        );

        $data['suntech_buysafe_installments'] = array();
        if (isset($this->request->post['suntech_buysafe_installments'])) {
            $data['suntech_buysafe_installments'] = $this->request->post['suntech_buysafe_installments'];
        } else {
            $data['suntech_buysafe_installments'] = $this->config->get('suntech_buysafe_installments');
        }

        if (isset($this->request->post['suntech_buysafe_cargo_option'])) {
            $data['suntech_buysafe_cargo_option'] = $this->request->post['suntech_buysafe_cargo_option'];
        } else {
            $data['suntech_buysafe_cargo_option'] = $this->config->get('suntech_buysafe_cargo_option');
        }
