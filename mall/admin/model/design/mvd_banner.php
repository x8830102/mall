...
class ModelDesignMVDBanner extends Model {
	...
	public function editBanner($banner_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', banner_sort = '" . $this->db->escape($data['banner_sort']) . "', status = '" . (int)$data['status'] . "' WHERE banner_id = '" . (int)$banner_id . "'");
