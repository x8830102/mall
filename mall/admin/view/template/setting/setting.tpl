          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_mail_smtp_host" value="<?php echo $config_mail_smtp_host; ?>" placeholder="<?php echo $entry_mail_smtp_hostname; ?>" id="input-mail-smtp-hostname" class="form-control" />
                </div>
              </div>
              <div class="form-group">
