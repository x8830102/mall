            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
				  <td class="text-left"><?php if ($sort == 'banner_sort') { ?>
                    <a href="<?php echo $sort_banner; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_banner; ?>"><?php echo $column_sort; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-left"><?php echo $banner['sort']; ?></td>
