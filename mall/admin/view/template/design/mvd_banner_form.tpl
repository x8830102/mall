      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-banner-sort"><span data-toggle="tooltip" title="<?php echo $help_sort_order; ?>"><?php echo $entry_sort_order; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="banner_sort" value="<?php echo $banner_sort; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-banner-sort" class="form-control" />
          </div>
		  </div>
          <div class="form-group">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                <td class="text-left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?>
                  <?php } ?></td>
                <td class="text-left" style="width: 25%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][link]" value="<?php echo $banner_image['link']; ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>
				...
				<td class="text-right" style="width: 8%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][banner_width]" value="<?php echo $banner_image['banner_width']; ?>" placeholder="<?php echo $entry_width; ?>" class="form-control" /></td>
				<td class="text-right" style="width: 8%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][banner_height]" value="<?php echo $banner_image['banner_height']; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" /></td>
                <td class="text-right" style="width: 15%;">
					<select name="banner_image[<?php echo $image_row; ?>][vendor_id]" class="form-control">
						<option value=""><?php echo $text_none; ?></option>
                        <?php foreach ($vendors as $vd) { ?>
                        <?php if ($banner_image['vendor_id'] == $vd['vendor_id']) { ?>
				...
				<td class="text-right" style="width: 8%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $banner_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
...
function addImage() {
	...
	<?php } ?>
	html += '  </td>';	
	html += '  <td class="text-left" style="width: 25%;"><input type="text" name="banner_image[' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';	
	...
	html += '  <td class="text-right" style="width: 8%;"><input type="text" name="banner_image[' + image_row + '][banner_width]" value="" placeholder="<?php echo $entry_width; ?>" class="form-control" /></td>';
	html += '  <td class="text-right" style="width: 8%;"><input type="text" name="banner_image[' + image_row + '][banner_height]" value="" placeholder="<?php echo $entry_height; ?>" class="form-control" /></td>';
	html += '  <td class="text-right" style="width: 15%;"><select name="banner_image[' + image_row + '][vendor_id]" class="form-control"><option value="0" selected="selected"><?php echo $text_none; ?></option>';
			   <?php foreach ($vendors as $vd) { ?>
	html += '  <option value="<?php echo $vd['vendor_id']; ?>"><?php echo $vd['vendor_name']; ?></option>';
			   <?php } ?>
	html += '  </select></td>';
	html += '  <td class="text-right" style="width: 8%;"><input type="text" name="banner_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
