          ...
          <div class="tab-pane active" id="tab-order">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><a href="<?php echo $customer; ?>" target="_blank"><?php echo $lastname; ?><?php echo $firstname; ?></a></td>
              </tr>
              <?php } else { ?>
              <tr>
                <td><?php echo $text_customer; ?></td>
          ...
          <div class="tab-pane" id="tab-product">
            <table class="table table-bordered">
              ...
              <tbody>
				...
				<tr>
                  <td colspan="4" class="text-right"><?php echo $shipping_weight; ?>:</td>
                  <td class="text-right"><?php echo $shipping_cost; ?></td>
                </tr>
				<?php } ?>
				<?php if ($coupon_amount) { ?>
				<tr>
                  <td colspan="4" class="text-right"><?php echo $coupon_title; ?>:</td>
                  <td class="text-right">-<?php echo $coupon_amount; ?></td>
                </tr>
				<?php } ?>
				<?php if ($tax) { ?>
				<tr>
                  <td colspan="4" class="text-right"><?php echo $tax_title; ?>:</td>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
					...
					<select name="order_status_id" id="input-order-status" class="form-control">
                      <?php foreach ($order_statuses as $order_statuses) { ?>
					  <?php if (in_array($order_statuses['order_status_id'], $mvd_sales_order_status_availability)) { ?>
                      <option value="<?php echo $order_statuses['order_status_id']; ?>" selected="selected"><?php echo $order_statuses['name']; ?></option>
                      <?php } ?>
                      <?php } ?>
                    </select>
...
$('#button-history').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&vendor_id=' + <?php echo $vendor_id;?> + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
