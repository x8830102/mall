    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-carousel" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-mode"><span data-toggle="tooltip" title="<?php echo $help_mode; ?>"><?php echo $entry_mode; ?></span></label>
            <div class="col-sm-10">
              <select name="mode" id="input-mode" class="form-control">
                <option value="1" <?php if ($mode == '1') { echo "selected=selected"; } ?>><?php echo $text_carousel; ?></option>
				<option value="2" <?php if ($mode == '2') { echo "selected=selected"; } ?>><?php echo $text_vertical; ?></option>
				<option value="3" <?php if ($mode == '3') { echo "selected=selected"; } ?>><?php echo $text_combo; ?></option>
              </select>
            </div>
          </div>
          <div class="form-group">
