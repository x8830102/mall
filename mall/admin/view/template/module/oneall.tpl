		...
		<form id="form-layout" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
			...
			<div class="container-fluid">
				<ul class="nav nav-tabs">
		          ...
		          <li class="">
		          	<a href="<?php echo $action; ?>&show=positions">
	...
	?>
		...
		<div class="container-fluid">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="<?php echo $action; ?>&show=positions"> <i class="fa fa-puzzle-piece"></i> <?php echo $oa_text_positions; ?></a></li>
			</ul>
			<?php  
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form id="form-layout" action="<?php echo $action; ?>&show=positions" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-sm-12">
											...
											foreach ($oa_oc_positions AS $oa_oc_position)
											{
												?>								
													<tr>
														...
														<td class="text-center col-sm-3">										
															<a href="<?php echo $action; ?>&show=positions&remove=<?php echo $oa_oc_position['layout_module_id']; ?>" class="btn btn-danger" type="button">
