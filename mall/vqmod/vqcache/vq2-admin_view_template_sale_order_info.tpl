                  ...
                  <div class="col-sm-10">
                    <select name="order_status_id" id="input-order-status" class="form-control">
                      ...
                      <?php } else { 
                                ...
                                case 1:
                                  if($order_statuses['order_status_id'] != 13){?>
                                    <option value="<?php echo $order_statuses['order_status_id']; ?>"><?php echo $order_statuses['name']; ?></option>
                                  <?php }
                                  break;
                                case 5:
                                  if($order_statuses['order_status_id'] == 11 || $order_statuses['order_status_id'] == 13) { ?>
                                    <option value="<?php echo $order_statuses['order_status_id']; ?>"><?php echo $order_statuses['name']; ?></option>
                                  <?php }
                                  break;
                                case 7:
  ...
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		...
		dataType: 'json',
			...
			data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&sent_comment_to_all=' + ($('input[name=\'sent_comment_to_all\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
