...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_maxpoints'] = $this->language->get('entry_maxpoints');
		...
		if (isset($this->error['maxpoints'])) {
			$data['error_maxpoints'] = $this->error['maxpoints'];
		} else {
			$data['error_maxpoints'] = '';
		}
		...
		if (isset($this->request->post['maxpoints'])) {
			$data['maxpoints'] = $this->request->post['maxpoints'];
		} elseif (!empty($product_info)) {
			$data['maxpoints'] = $product_info['maxpoints'];
		} else {
			$data['maxpoints'] = 0;
		}
	...
	protected function validateForm() {
		...
		if ($this->request->post['maxpoints'] < 0) {
			$this->error['maxpoints'] = $this->language->get('error_maxpoints');
		}

		if ($this->request->post['price'] < $this->request->post['maxpoints']) {
			$this->error['maxpoints'] = $this->language->get('error_maxpoints');
		}
