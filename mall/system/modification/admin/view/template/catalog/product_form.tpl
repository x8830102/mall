          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" name="price" min="0" value="<?php echo $price; ?>" placeholder="<?php echo $entry_price; ?>" id="input-price" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="special-row<?php echo $special_row; ?>">
                      ...
                      <td class="text-right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $product_special['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" onkeyup="check()" tag="special" /></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
            ...
            <div class="tab-pane" id="tab-reward">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline" id="touse">
                    <?php if(isset($product_special['price'])){
                            if ($points) { ?>
                              <input type="radio" name="points" tag="wannause" value="<?php echo $product_special['price']; ?>" checked="checked" />
                              <?php echo $text_yes; ?>
                              <?php } else { ?>
                              <input type="radio" name="points" tag="wannause" value="<?php echo $product_special['price']; ?>" />
                              <?php echo $text_yes; }?>
                    <?php } else { 
                            if ($points) { ?>
                              <input type="radio" name="points" tag="wannause" value="<?php echo $price; ?>" checked="checked" />
                              <?php echo $text_yes; ?>
                              <?php } else { ?>
                              <input type="radio" name="points" tag="wannause" value="<?php echo $price; ?>" />
                              <?php echo $text_yes; }?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$points) { ?>
                    <input type="radio" name="points" tag="notuse" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="points" tag="notuse" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              </div>
              <div class="form-group" id="maxpoints">
                <label class="col-sm-2 control-label" for="input-maxpoints"><span data-toggle="tooltip" title="<?php echo $help_points; ?>"><?php echo $entry_maxpoints; ?></span></label>
                <div class="col-sm-10">
                  <input type="number" name="maxpoints" min="0" value="<?php echo $maxpoints; ?>" placeholder="<?php echo $price; ?>" id="input-maxpoints" class="form-control"/>
                </div>
              </div>
            </div>
            <script type="text/javascript">
              $(document).ready(function(){
                //初次檢查
                maxpoints = <?php if(empty($maxpoints)){
                                    echo 0;  
                                  }else{
                                    echo $maxpoints;} ?>;
                if(maxpoints >= 0){
                  if($('input[name=price]').val() <= 0){
                    $('input[name=maxpoints]').val('0');
                    $('#maxpoints').hide();
                    $('#touse').hide();
                  }else if($('input[tag=notuse]').is(':checked')){
                    $('#maxpoints').hide();
                  }else{
                    $('#maxpoints').show();
                    }
                ...
                $('input[name=points]').change(function(){
                  ...
                  if($('input[tag=special]').val() > 0){
                    $('input[tag=wannause]').val($('input[tag=special]').val());
                  }
                });
                //價格輸入連動檢查
                $('input[name=price]').change(function(){
                  $('input[tag=wannause]').val($('input[name=price]').val());
                  if($('input[name=price]').val() <= 0){
                    $('input[name=maxpoints]').val('0');
                    $('#maxpoints').hide();
                  }else if($('input[tag=notuse]').is(':checked')){
...
function addSpecial() {
	...
	html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" onkeyup="check()" tag="special" /></td>';
...
//--></script></div>
                ...
                <input type="hidden" value="<?php echo $last_folder; ?>" id="last-folder">
