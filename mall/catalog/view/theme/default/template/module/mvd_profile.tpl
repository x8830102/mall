...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  ...
	  <div class="image"><a href="<?php echo $link; ?>"><img src="<?php echo $image; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" class="img-responsive" /></a></div>
	  <legend></legend>
	  <div>
        <table>
          <tbody>
              <tr>
                <td style="width:40%"><strong><?php echo $text_company_name; ?></strong></td>
