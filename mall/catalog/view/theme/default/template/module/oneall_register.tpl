  ...
  <div class="row">
    <div id="content" class="col-sm-12">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="account">
          <legend><?php echo $oa_heading_desc ?></legend>
          ...
          <div class="form-group required">
            ...
            <?php }else{ ?>
              <input type="text" name="username" value="<?php echo $emailname[0];?>" placeholder="<?php echo $entry_username; ?>" id="input-username" class="form-control" />
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-fname"><?php echo $entry_fname; ?></label>
            <div class="col-sm-10">
              <input type="text" name="fname" value="<?php echo $fname; ?>" placeholder="<?php echo $entry_fname; ?>" id="input-fname" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
