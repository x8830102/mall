...
<div id="shipping-existing">
  <select name="address_id" class="form-control">
    ...
    <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['lastname']; ?><?php echo $address['firstname']; ?>, <?php echo $address['country']; ?>, <?php echo $address['postcode']; ?><?php echo $address['zone']; ?><?php echo $address['city']; ?><?php echo $address['address_1']; ?></option>
    <?php } else { ?>
    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['lastname']; ?><?php echo $address['firstname']; ?>, <?php echo $address['country']; ?>, <?php echo $address['postcode']; ?><?php echo $address['zone']; ?><?php echo $address['city']; ?><?php echo $address['address_1']; ?></option>
    <?php } ?>
    <?php } ?>
  </select>
</div>
...
<?php foreach ($fields as $field) { ?>
  ...
  <?php } elseif ($field == 'zone') { ?>
    <?php if (!empty(${'field_' . $field}['display'])) { ?>
	  <div class="row custom-field reg-fields">
	  	<div class="col-sm-5 reg-field">
