          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <select name="city" id="input-city" class="form-control">
                <option value="" id="city"><?php echo $text_select; ?></option>
                <?php
                  $pdo = new PDO("mysql:host=localhost;dbname=twliveli_mall;charset=utf8","twlivelinkcom","rgn26842");
                  $stmt = $pdo->query("SELECT * FROM oc_zone_to_district ORDER BY postcode");
