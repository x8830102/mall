	...
	<table class="table table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<a href="<?php echo $product['reorder']; ?>" title="<?php echo $button_reorder; ?>" class="btn-xs default-btn"><?php echo $button_reorder; ?></a>
				<?php } ?>
				<a href="<?php echo $product['return']; ?>" title="<?php echo $button_return; ?>" class="btn-xs primary-btn"><?php echo $button_return; ?></a></td>
			</tr>
			<?php } ?>
