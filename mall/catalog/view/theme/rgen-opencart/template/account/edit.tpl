...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	<div class="frm-wrp">
		<fieldset>
			<legend class="frm-hd"><?php echo $text_your_details; ?></legend>
			<input type="hidden" name="username" value="<?php echo $username; ?>" id="input-username" class="form-control" />
	...
	<div class="buttons clearfix">
		...
		<input type="submit" value="<?php echo $button_continue; ?>" class="primary-btn" />
		</div>
	</div>
</form>
