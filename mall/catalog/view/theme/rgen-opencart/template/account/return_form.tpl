...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	<div class="frm-wrp">
		<fieldset>
			<legend class="frm-hd"><?php echo $text_order; ?></legend>
	...
	<div class="frm-wrp">
		<fieldset>
			<legend class="frm-hd"><?php echo $text_product; ?></legend>
			<div class="form-group required">
	...
	<div class="buttons clearfix">
		<div class="pull-left"><a href="<?php echo $back; ?>" class="primary-btn"><?php echo $button_back; ?></a></div>
		<div class="pull-right"><?php echo $text_agree; ?>
			...
			<?php } ?>
			<input type="submit" value="<?php echo $button_submit; ?>" class="default-btn" />
		</div>
	</div>
	<?php } else { ?>
	<div class="buttons clearfix">
		<div class="pull-left"><a href="<?php echo $back; ?>" class="default-btn"><?php echo $button_back; ?></a></div>
		<div class="pull-right"><input type="submit" value="<?php echo $button_submit; ?>" class="primary-btn" /></div>
	</div>
	<?php } ?>
</form>
