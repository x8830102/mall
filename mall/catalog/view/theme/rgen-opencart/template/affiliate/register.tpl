...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<div class="frm-wrp">
		<fieldset>
			<legend class="frm-hd"><?php echo $text_your_address; ?></legend>
			<div class="form-group">
	...
	<div class="frm-wrp">
		<fieldset>
			<legend class="frm-hd"><?php echo $text_payment; ?></legend>
			<div class="form-group">
	...
	<div class="frm-wrp">
		<fieldset>
			<legend class="frm-hd"><?php echo $text_your_password; ?></legend>
			<div class="form-group required">
	...
	<?php } else { ?>
	<div class="buttons clearfix">
		<div class="pull-right"><input type="submit" value="<?php echo $button_continue; ?>" class="default-btn" /></div>
	</div>
	<?php } ?>
</form>
