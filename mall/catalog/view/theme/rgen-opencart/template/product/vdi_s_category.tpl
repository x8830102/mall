...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-sm-9 col-xs-12"><?php echo $content_top; ?>
          ...
          <div class="product-thumb">
            ...
            <div>
              ...
              <div class="button-group">
                <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-md"><?php echo $button_cart; ?></span></button>
                <button type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
                <button type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
                <a href="index.php?route=quickcheckout/checkout"><button type="button"  data-toggle="tooltip" title="前往結帳" onclick="cart.add('<?php echo $product['product_id']; ?>');" >結帳</button></a>
              </div>
            </div>
          </div>
        </div>
