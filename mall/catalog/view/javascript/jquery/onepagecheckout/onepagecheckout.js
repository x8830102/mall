function moduleLoad(element, spinner) {
	if (spinner) {
		element.find('.quickcheckout-content').html('<div class="text-center"><i class="fa fa-refresh fa-spin fa-5x"></i></div>');
	} else {
		...
		if (height > 30) {
			html = '<div class="overlay" style="position:absolute;bottom:0;left:0;z-index:99999;background:none;width:' + width + 'px;height:' + height + 'px;text-align:center;"><i class="fa fa-refresh fa-spin fa-5x" style="margin-top:' + margin + 'px;"></i></div>';
