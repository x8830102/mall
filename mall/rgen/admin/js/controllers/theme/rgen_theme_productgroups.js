(function(){
	...
	angular.module('rgen').controller('themeProductgroups', [
		'$scope', 
		'Rest', 
		'Pop', 
		'Loader',
		...
		function($scope, Rest, Pop, Loader, Mod){
			...
			$scope.fontObj = function () {
				return _.object([
					...
					[$scope.modId+'.d.mod_sub_hd'   , Rest.objChk($scope.themeData, 'd.mod_sub_hd') ? Rest.findFonts($scope.themeData.d.mod_sub_hd) : null ],
					[$scope.modId+'.t.mod_sub_hd'   , Rest.objChk($scope.themeData, 't.mod_sub_hd') ? Rest.findFonts($scope.themeData.t.mod_sub_hd) : null ],
					[$scope.modId+'.m.mod_sub_hd'   , Rest.objChk($scope.themeData, 'm.mod_sub_hd') ? Rest.findFonts($scope.themeData.m.mod_sub_hd) : null ],

					[$scope.modId+'.d.tab1.tab_item'   , Rest.objChk($scope.themeData, 'd.tab1.tab_item') ? Rest.findFonts($scope.themeData.d.tab1.tab_item) : null ],
					[$scope.modId+'.t.tab1.tab_item'   , Rest.objChk($scope.themeData, 't.tab1.tab_item') ? Rest.findFonts($scope.themeData.t.tab1.tab_item) : null ],
					[$scope.modId+'.m.tab1.tab_item'   , Rest.objChk($scope.themeData, 'm.tab1.tab_item') ? Rest.findFonts($scope.themeData.m.tab1.tab_item) : null ],
