(function(){
	'use strict';
	angular.module('rgen').controller('moduleDealsAssign', [
		'$scope', 
		'Rest', 
		'Pop', 
		'Loader',
		...
		'Mod',
		'SweetAlert',
		function($scope, Rest, Pop, Loader, $state, $modal, dealsFactory, Mod, SweetAlert){
			...
			$scope.modConetnt.data.push(new dealsFactory.assign());
			...
			$scope.newItem = function() {
				var temp 			= new dealsFactory.assign();
