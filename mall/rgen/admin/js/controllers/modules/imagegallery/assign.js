(function(){
	'use strict';
	angular.module('rgen').controller('moduleImagegalleryAssign', [
		'$scope', 
		'Rest', 
		'Pop', 
		'Loader',
		...
		'Mod',
		'SweetAlert',
		function($scope, Rest, Pop, Loader, $state, $modal, imagegalleryFactory, Mod, SweetAlert){
			...
			$scope.modConetnt.data.push(new imagegalleryFactory.assign());
			...
			$scope.newItem = function() {
				var temp 			= new imagegalleryFactory.assign();
