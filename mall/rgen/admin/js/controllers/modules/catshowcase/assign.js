(function(){
	'use strict';
	angular.module('rgen').controller('moduleCatshowcaseAssign', [
		'$scope', 
		'Rest', 
		'Pop', 
		'Loader',
		...
		'Mod',
		'SweetAlert',
		function($scope, Rest, Pop, Loader, $state, $modal, catshowcaseFactory, Mod, SweetAlert){
			...
			$scope.modConetnt.data.push(new catshowcaseFactory.assign());
			...
			$scope.newItem = function() {
				var temp 			= new catshowcaseFactory.assign();
