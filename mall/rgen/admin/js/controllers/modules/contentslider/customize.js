(function(){
	...
	angular.module('rgen').controller('moduleContentsliderCustomize', [
		'$scope', 
		'Rest', 
		'Pop', 
		'Loader',
		...
		function($scope, Rest, Pop, Loader, Mod){
			...
			$scope.tpl = {
				block1      : tpl('modules/contentslider/theme_block1')
			}
			...
			$scope.fontObj = function () {
				...
				return _.object([
					...
					// Content block 1
					[fontPrefix+'.d.ctn_block1.hd'   , Rest.objChk($scope.themeData, 'd.ctn_block1.setting.hd') ? Rest.findFonts($scope.themeData.d.ctn_block1.setting.hd) : null ],
					[fontPrefix+'.d.ctn_block1.info'   , Rest.objChk($scope.themeData, 'd.ctn_block1.setting.info') ? Rest.findFonts($scope.themeData.d.ctn_block1.setting.info) : null ],
