(function(){
	'use strict';
	angular.module('rgen').controller('moduleContentsliderAssign', [
		'$scope', 
		'Rest', 
		'Pop', 
		'Loader',
		...
		'Mod',
		'SweetAlert',
		function($scope, Rest, Pop, Loader, $state, $modal, contentsliderFactory, Mod, SweetAlert){
			...
			$scope.modConetnt.data.push(new contentsliderFactory.assign());
			...
			$scope.newItem = function() {
				var temp 			= new contentsliderFactory.assign();
