...
<script type="text/ng-template" id="col_renderer.html">
	<div ui-tree-handle>
		...
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Content view style :</i> {{column.item_data.content_view.view}}</b>
		</div>
...
<script type="text/ng-template" id="item_renderer.html">
	<div ui-tree-handle class="no-sub">
		...
		<span class="img-preview"><img ng-src="{{item.item_data.setting.image.img}}" alt=""></span>
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Pop-up :</i> {{item.item_data.setting.popup_status}}</b>
			<b class="rgen-lbl white" ng-if="column.item_data.content_view.view == 'masonry'"><i>Size :</i> {{item.item_data.setting.w}} x {{item.item_data.setting.h}}</b>
			<b class="rgen-lbl white" ng-if="column.item_data.content_view.view == 'grid' || column.item_data.content_view.view == 'carousel'"><i>Size :</i> {{column.item_data.content_view.image_w}} x {{column.item_data.content_view.image_h}} (px)</b>
		</div>
		...
		<div class="btn-r show-btn">
	  		<div class="btn-wrp">
				...
				<a class="rgen-btn mini fs16" tooltip="Settings" nodrag ng-click="open(this, 'block', column)"><i class="fa fa-cog"></i></a>
			</div>
