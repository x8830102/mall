...
<div ng-if="!module">
	<div class="alert alert-warning">No module available. <a ui-sref="mod_imagegallery" class="dark rgen-btn mini">Create module</a></div>
</div>
							...
							<div class="fields">
								<ul class="form-row">
									<li>
										...
										<rgen-box type="alone" config="{fonts:0}" buttonlabel="Edit" data-ng-model="themeData[manage_tab].image_block.block"></rgen-box>
									</li>
									<li>
										<label class="lbl">Image overlay</label>
										<rgen-colorpicker type="alone" label="Text color" data-ng-model="themeData[manage_tab].image_block.overlay"></rgen-colorpicker>
									</li>
									<li>
										<label class="lbl">Icon</label>
										<rgen-button type="alone" config="{fonts:0}" buttonlabel="Edit" data-ng-model="themeData[manage_tab].image_block.icon"></rgen-button>
									</li>
								</ul>
							</div>
						</div>
