			...
			<section class="rgen-panel">
				...
				<div class="panel-container">
					<div class="rgen-form-wrp form-full form-medium">
						...
						<div ng-if="themeData.ctn_block == '2'" ng-include="tpl.block2"></div>
						<div ng-if="themeData.ctn_block == '3'" ng-include="tpl.block3"></div>
						<div ng-if="themeData.ctn_block == '4'" ng-include="tpl.block4"></div>
						<div ng-if="themeData.ctn_block == '_small1'" ng-include="tpl.smallblock1"></div>
						<div ng-if="themeData.ctn_block == '_small2'" ng-include="tpl.smallblock2"></div>
