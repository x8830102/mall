...
<script type="text/ng-template" id="item_renderer.html">
	<div ui-tree-handle class="no-sub">
		...
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Style :</i> {{item.item_data.setting.style}}</b>
			<b class="rgen-lbl white"><i>Title :</i> {{item.item_data.setting.title_status}}</b>
			<b class="rgen-lbl white"><i>Description :</i> {{item.item_data.setting.description_status}}</b>
			<b class="rgen-lbl white"><i>Image :</i> {{item.item_data.setting.image_status}}</b>
			<b class="rgen-lbl white"><i>Button :</i> {{item.item_data.setting.btn_status}}</b>
		</div>
