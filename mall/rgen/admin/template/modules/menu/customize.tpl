...
<div ng-if="!module">
	<div class="alert alert-warning">No module available. <a ui-sref="mod_menu" class="dark rgen-btn mini">Create module</a></div>
</div>
					...
					<div class="field-box">
						...
						<div class="fields">
							<ul class="form-row">
								...
								<li>
									<label class="lbl">First link</label>
									<rgen-button type="alone" config="{ fonts:0 }" buttonlabel="Edit" data-ng-model="themeData.menuitem.first_link"></rgen-button>
								</li>
								<li>
									<label class="lbl">Last link</label>
									<rgen-button type="alone" config="{ fonts:0 }" buttonlabel="Edit" data-ng-model="themeData.menuitem.last_link"></rgen-button>
								</li>
							</ul>
						</div>
					</div>
		...
		<section class="rgen-panel">
			...
			<div class="panel-container">
				<div class="rgen-form-wrp form-full form-medium">
					...
					<rgen-box label="Sub menu" config="{fonts:0}" buttonlabel="Edit" data-ng-model="themeData.m_sub"></rgen-box>
