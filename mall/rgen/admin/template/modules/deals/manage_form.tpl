...
<script type="text/ng-template" id="col_renderer.html">
	<div ui-tree-handle>
		...
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Style :</i> {{column.item_data.content_view.style}}</b>
			<b class="rgen-lbl white"><i>View :</i> {{column.item_data.content_view.view}}</b>
		</div>
...
<script type="text/ng-template" id="item_renderer.html">
	<div ui-tree-handle class="no-sub">
		...
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Product type :</i> {{item.item_data.setting.prdtype}}</b>
			<b class="rgen-lbl white"><i>Image size :</i> {{item.item_data.setting.image_w}} x {{item.item_data.setting.image_h}}</b>
			<b class="rgen-lbl white"><i>Extra images :</i> {{item.item_data.setting.sub_image_status}}</b>
			<b class="rgen-lbl white"><i>Cart :</i> {{item.item_data.setting.cart_status}}</b>
			<b class="rgen-lbl white"><i>Wish list :</i> {{item.item_data.setting.wishlist_status}}</b>
			<b class="rgen-lbl white"><i>Compare :</i> {{item.item_data.setting.compare_status}}</b>
		</div>
