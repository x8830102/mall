...
<script type="text/ng-template" id="item_renderer.html">
	<div ui-tree-handle class="no-sub">
		...
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Title :</i> {{item.item_data.content.title_status}}</b>
			<b class="rgen-lbl white"><i>Description :</i> {{item.item_data.content.description_status}}</b>
		</div>
