	...
	<div ui-tree-handle>
		...
		<div class="btn-r show-btn">
	  		<div class="btn-wrp">
		  		...
		  		<a class="rgen-btn mini fs16" tooltip="Style customization" nodrag ng-click="open(this, 'customize', row)"><i class="fa fa-paint-brush"></i></a>
...
<script type="text/ng-template" id="item_renderer.html">
	<div ui-tree-handle class="no-sub">
		...
		<div class="detail-preview">
			<hr>
			<b class="rgen-lbl white"><i>Content type :</i> {{item.item_data.setting.block_type == 'mod' ? 'Module item' : 'HTML content'}}</b>
		</div>
