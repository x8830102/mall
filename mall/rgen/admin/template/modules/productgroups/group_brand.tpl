<section class="rgen-panel">
	<h2 class="hd">Manufacturer products</h2>
	<div class="panel-container">
		<div class="rgen-form-wrp form-full form-medium">
			<rgen-typeaheadsingle label="Select brand" pholder="Enter text to search" size="w-large" searchtype="brand" data-ng-model="modaldata.setting.brand"></rgen-typeaheadsingle>
			<div class="field-box">
				<label class="tip">
					Product settings
