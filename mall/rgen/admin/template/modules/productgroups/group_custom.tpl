<section class="rgen-panel">
	<h2 class="hd">Custom product selection</h2>
	<div class="panel-container">
		<div class="rgen-form-wrp form-full form-medium">
			<rgen-typeahead label="Select products" pholder="Enter text to search" size="w-large" searchtype="product" data-ng-model="modaldata.setting.products"></rgen-typeahead>
			<div class="field-box">
				<label class="tip">
					Product settings
