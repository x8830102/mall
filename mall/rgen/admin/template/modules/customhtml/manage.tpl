		...
		<section class="rgen-panel">
			...
			<div class="panel-container htmlcontent-panel">
				...
				<!-- customhtml_places.jpg -->
					...
					<rgen-radio ng-if="active_place == 'l' || active_place == 'm' || active_place == 'r'" label="Column gutter" fhelp="Gutter value only apply if LEFT or RIGHT content active" radiodata="gutter" size="mini" data-ng-model="modConetnt.common.gt"></rgen-radio>
					...
					<div ng-if="active_place == 'm'">
						<h3 class="rgen-hd-1">Middle HTML content</h3>
						<rgen-onoff label="Status" data-ng-model="modConetnt.common.middle.status"></rgen-onoff>
						<rgen-radio label="Column size" radiodata="col_sizes" size="mini" data-ng-model="modConetnt.common.middle.size"></rgen-radio>
						<rgen-textarea label="HTML Content" size="w-full h-250 code-input" data-ng-model="modConetnt.common.middle.html"></rgen-textarea>
						<!-- <rgen-langcontent label="HTML Content" data-ng-model="modConetnt.common.left.html"></rgen-langcontent> -->
					</div>
