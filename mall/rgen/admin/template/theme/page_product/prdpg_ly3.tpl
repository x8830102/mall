<rgen-reset resetfn="reset('prdpg_ly3')" data-ng-model="themeData.status"></rgen-reset>
...
<section class="rgen-panel">
	<h2 class="hd">Offer info</h2>
	<div class="panel-container">
		<div class="rgen-form-wrp form-full form-medium">
			<rgen-box label="Offer block" config="{fonts:0, align:1, color:1, f_size:1}" buttonlabel="Edit" data-ng-model="themeData.offer_info"></rgen-box>
			<div class="field-box">
				<label>Details</label>
				<div class="fields">
					<ul class="form-row">
						<li>
							...
							<rgen-colorpicker type="alone" label="Reward" data-ng-model="themeData.reward"></rgen-colorpicker>
						</li>
						<li>
							<label class="lbl">Discounts</label>
							<rgen-colorpicker type="alone" label="Discounts" data-ng-model="themeData.discount"></rgen-colorpicker>
						</li>
					</ul>
				</div>
			</div>
