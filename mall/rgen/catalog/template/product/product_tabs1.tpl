...
/* PRODUCT CUSTOM TABS
**************************/
include $this->rgen('prd_customtabs'); ?>

<div class="nav-tabs1">
	<ul class="nav nav-tabs">
		<?php if ($rgen['prdpg_options_status'] || $rgen['prdpg_cart_status'] || $rgen['prdpg_wishlist_status'] || $rgen['prdpg_compare_status']) { ?>
		<li><a href="#tab-options" data-toggle="tab"><?php echo $prd_option_tab; ?></a></li>
		<?php } ?>
	...
	<div class="tab-content">
		...
		**************************/ ?>
		<?php if ($rgen['prdpg_specification_status']) { ?>
		<?php if ($attribute_groups) { ?>
		<div class="tab-pane<?php echo $rgen['prdpg_description_status'] == false ? ' active' : null; ?>" id="tab-specification">
