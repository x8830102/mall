<div 
	class="menu-infobox-block menu-infobox1<?php echo $infobox['margin_b']; ?>" 
	...
	<div class="text"><?php echo html_entity_decode($infobox['description'][$lng], ENT_QUOTES, 'UTF-8'); ?></div>
	<?php } ?>
	<?php } ?>
