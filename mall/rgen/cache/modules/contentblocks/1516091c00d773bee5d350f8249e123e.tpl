<div id="rgen-contentblocks-rgenEormE9" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
							<h3 class="name">
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenEormE9 .contentblock-grid', '#rgen-contentblocks-rgenEormE9 .contentblock-grid > .cl');
								});
								</script>
