<div id="rgen-contentblocks-rgenorHNe4" class="rgen-contentblocks contentblocks-rgQtX">
	...
	<div class="ctn-inner-wrp">
		...
		<div class="text-wrp">
						...
						<div class="text">網路社群行銷新趨勢，與串門子商城共享經濟，創造事業巔峰</div>
					</div>
	...
	<div class="ctn-inner-wrp">
		...
		<div class="text-wrp">
						...
						<div class="text">串門子雲盟不會電話聯繫您，若有疑慮請直撥165反詐騙專線</div>
					</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenorHNe4 .contentblock-grid', '#rgen-contentblocks-rgenorHNe4 .contentblock-grid > .cl');
								});
								</script>
