<div id="rgen-contentblocks-rgen9jDlL3" class="rgen-contentblocks contentblocks-rgQtX">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgen9jDlL3 .contentblock-grid', '#rgen-contentblocks-rgen9jDlL3 .contentblock-grid > .cl');
								});
								</script>
