<div id="rgen-contentblocks-rgen7e2IjN" class="rgen-contentblocks contentblocks-rgQtX">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgen7e2IjN .contentblock-grid', '#rgen-contentblocks-rgen7e2IjN .contentblock-grid > .cl');
								});
								</script>
