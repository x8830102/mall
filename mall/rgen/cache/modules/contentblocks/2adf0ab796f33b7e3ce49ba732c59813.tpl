<div id="rgen-contentblocks-rgen3KqOOd" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
							<h3 class="name">
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgen3KqOOd .contentblock-grid', '#rgen-contentblocks-rgen3KqOOd .contentblock-grid > .cl');
								});
								</script>
