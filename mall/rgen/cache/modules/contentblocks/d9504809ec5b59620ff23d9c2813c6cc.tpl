<div id="rgen-contentblocks-rgenPcilas" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
							<h3 class="name">
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenPcilas .contentblock-grid', '#rgen-contentblocks-rgenPcilas .contentblock-grid > .cl');
								});
								</script>
