<div id="rgen-basicslideshow-rgenHBJY1K" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgenHBJY1K > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgenHBJY1K .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgenHBJY1K .slideshow").sudoSlider({
		responsive: true,
