<div id="rgen-basicslideshow-rgenVuZHDf" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgenVuZHDf > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgenVuZHDf .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgenVuZHDf .slideshow").sudoSlider({
		responsive: true,
