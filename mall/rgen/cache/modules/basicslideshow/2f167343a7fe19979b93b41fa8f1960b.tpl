<div id="rgen-basicslideshow-rgennXo8c5" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgennXo8c5 > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgennXo8c5 .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgennXo8c5 .slideshow").sudoSlider({
		responsive: true,
