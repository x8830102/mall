<div id="rgen-basicslideshow-rgenSvKgWN" class="rgen-basicslideshow basicslideshow-rgNUo">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgenSvKgWN > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgenSvKgWN .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgenSvKgWN .slideshow").sudoSlider({
		responsive: true,
