...
$card=$row_Recsn['card'];
$fus=$_SESSION['gfus'];$newnr=$_SESSION['newnr'];$pudid=$_SESSION['pudid'];$vfdcard=$_SESSION['fdcard'];//echo "##c-",$vfdcard;exit;
?>
...
<?php exit;
mysql_select_db($database_sc, $sc);
$query_Reccd = sprintf("SELECT * FROM fd WHERE at=0 ORDER BY id");
...
mysql_query($insertCommand13,$sc);
    ...
    mysql_query($insertCommand15,$sc);*/
		//
		$update11="UPDATE fd SET at=1,fnumber='$fdcard',okdata='$date' WHERE id=$tid";
        mysql_select_db($database_sc, $sc);
        $Result11 = mysql_query($update11, $sc) or die(mysql_error());
		}
		//
